...
public class ParsedDataInserter {
    ...
    public static void main(String[] args) {
        ...
        } else logger.info("\"-scrape-paper-author-event\" argument was not found, skipping event scraping");
        //only scrape if respective argument was foun
        if(argsList.contains("-scrape-acl18-info")) logger.info("ACLWebCrawler not implemented");
        else logger.info("\"-scrape-acl18-info\" argument was not found, skipping ACL 2018 scraping");
    ...
    private void completeAuthorsByS2(int n) {
        ...
        for (Person currPerson : authors) {
            ...
            try {
                S2APIFunctions.completeAuthorInformationByAuthorSearch(currPerson, false);
